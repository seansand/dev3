...
(1..3).each()
{
   ...
   request.content += "test" //day.toString().substring(0, 1) + ":";
   request.content += "test" //text.toString().substring(0, Math.min(9, text.toString().size())) + ":";
   request.content += "test" //"${high.toString()}/${low.toString()}";
   request.content += "\\n";   
}
